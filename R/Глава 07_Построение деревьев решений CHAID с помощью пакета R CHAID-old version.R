...
#Если угадываем число банкротов , то : Чувствительность =число банкротов , которые мы угадали/число всех 
#Специфичность= число платежеспособных /число всех
...
#модели, а на десятом проверить модель. В качестве метрики качества используем 
# правильность.
#Правильность – это процент правильно классифицированных наблюдений (или просто процент правильных прогнозов).
#Правильность= предсказанные верно/(предсказанные верно+предсказанные неверно)*100
